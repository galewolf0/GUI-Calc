This repository contains a simple calculator application built using PyQt5 in Python. The calculator performs basic arithmetic operations such as addition, subtraction, multiplication, and division.
